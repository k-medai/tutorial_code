...
df_drugs_smiles = pd.read_csv('utils/all_smiles.csv')
...
df_all_pos_ddi = pd.read_csv('utils/all_pairs.csv')
all_pos_tup = [(h, t, r) for h, t, r in zip(df_all_pos_ddi['Drug1_ID'], df_all_pos_ddi['Drug2_ID'], df_all_pos_ddi['Y'])]
